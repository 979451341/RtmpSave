...
JNIEXPORT jint JNICALL Java_com_ws_ffmpegandroidavfilter_NativePlayer_saveRTMP
    ...
    int videoindex=-1;
    int frame_index=0;
    in_filename = env->GetStringUTFChars(in_filename_, 0) ;
    //in_filename  = "rtmp://live.hkstv.hk.lxdns.com/live/hks";

    out_filename = env->GetStringUTFChars(out_filename_, 0) ;
    //out_filename = "/storage/emulated/0/pauseRecordDemo/video/receive.flv";
